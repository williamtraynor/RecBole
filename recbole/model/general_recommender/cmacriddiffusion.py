...
class CMacridDiffusion(GeneralRecommender):
    ...
    def __init__(self, config, dataset):
        super(CMacridDiffusion, self).__init__(config, dataset)
        ...
        self.encode_layer_dims = (
            [self.n_items] + self.layers + [(self.embedding_size + self.l_embedding_size)]
        )
        ...
        # Time embedding
        self.time_emb_dim = self.embedding_size + self.l_embedding_size
